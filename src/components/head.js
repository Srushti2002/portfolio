                    ...
                    <div className={classes.headWrite}>
                        ...
                        <div className={classes.headLink}>
                            ...
                            <div className={classes.headContant}>
                                <a href="https://www.linkedin.com/in/srushti-deshmukh-616111221/" aria-label="LinkedIn" target="_blank" rel="noreferrer"><FiLinkedin /></a>
                                <a href="https://github.com/Srushti2002" aria-label="GitHub" target="_blank" rel="noreferrer"><FiGithub /></a>
                                <a href="https://instagram.com/srushtideshmukh27?igshid=ZWIzMWE5ZmU3Zg==" aria-label="Instagram" target="_blank" rel="noreferrer"><FiInstagram /></a>
                                <a href="https://mail.google.com/mail/?view=cm&to=srushtideshmukh54@gmail.com" aria-label="Email" target="_blank" rel="noreferrer"><FiMail /></a>
                            </div>
                        </div>
                    </div>
